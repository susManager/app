...
public class Settings implements Initializable {
    ...
    private void switchThemePre() {
        switch (selectTheme.getValue()) {
            case "Default" -> color_switchToDefault();
            case "Nord" -> color_switchToNord();
            case "Tokyo Night" -> color_switchToTokyoNight();
            case "Gruvbox" -> color_switchToCafe();
            case "Light" -> color_switchToLight();
            case "Light Peach" -> color_switchToLightPeach();
            case "Dark" -> color_switchToDark();
        }
    }
}